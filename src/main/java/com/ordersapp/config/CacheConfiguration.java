...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ordersapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ordersapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.ordersapp.domain.User.class.getName());
            createCache(cm, com.ordersapp.domain.Authority.class.getName());
